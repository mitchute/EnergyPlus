...
This output is the operating total COP of the integrated heat pump. At each timestep, it is calculated as the sum of the delivered space cooling, space heating, and water heating rates divided by Integrated Heat Pump Electricity Rate.

\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values, including zero values while the integrated heat pump is off. This value is not the COP for the reporting period. Calculate reporting-period COP by dividing the sum of Integrated Heat Pump Air Total Cooling Energy, Integrated Heat Pump Air Heating Energy, and Integrated Heat Pump Water Heating Energy by Integrated Heat Pump Electricity Energy over the same period.}
