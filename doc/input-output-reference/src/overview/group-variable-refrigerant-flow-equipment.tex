...
\emph{At reporting frequencies longer than ``detailed,'' this value is the time-weighted average of the timestep COP values, including zero values while the heat pump is not heating. It is not the heating COP for the reporting period. Calculate reporting-period heating COP by dividing summed delivered heating energy by the summed input energy components included in this COP definition over the same period.}
...
\emph{At reporting frequencies longer than ``detailed,'' this value is the time-weighted average of the timestep COP values, including zero values while the heat pump is off. It is not the overall COP for the reporting period. Calculate reporting-period COP by dividing summed delivered cooling and heating energy by the summed input energy components included in this COP definition over the same period.}
