...
\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values. This value is not the COP for the reporting period. Calculate reporting-period compressor-rack COP by dividing summed Refrigeration Compressor Rack Total Heat Transfer Energy by summed Refrigeration Compressor Rack Electricity Energy over the same period.}
...
\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values. This value is not the COP for the reporting period. Calculate reporting-period compressor-rack COP by dividing summed Refrigeration Air Chiller Compressor Rack Total Heat Transfer Energy by summed Refrigeration Air Chiller Compressor Rack Electricity Energy over the same period.}
...
This output is the operating system-average compressor COP, calculated at each simulation timestep as the total refrigeration effect divided by the total power to the compressors.

\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values, including zero values while the system is inactive. This value is not the compressor COP for the reporting period. Calculate reporting-period compressor COP by dividing summed Refrigeration System Total Compressor Heat Transfer Energy by summed Refrigeration System Total Compressor Electricity Energy over the same period.}
...
\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values, including zero values while the system is inactive. This value is not the compressor COP for the reporting period. Calculate reporting-period compressor COP by dividing summed Refrigeration Air Chiller System Total Compressor Heat Transfer Energy by summed Refrigeration Air Chiller System Total Compressor Electricity Energy over the same period.}
...
This output is the operating system-average compressor COP, calculated at each simulation timestep as the total refrigeration effect divided by the total power to all of the compressors.

\emph{At reporting frequencies longer than ``detailed,'' EnergyPlus reports the time-weighted average of the timestep COP values, including zero values while the system is inactive. This value is not the compressor COP for the reporting period. Calculate reporting-period compressor COP from the appropriate summed refrigeration-effect energies divided by summed Refrigeration Transcritical System Total Compressor Electricity Energy over the same period.}
