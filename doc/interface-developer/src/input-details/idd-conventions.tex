...
To assist you in using the \href{https://energyplus.readthedocs.io/en/latest/guides/input-output-reference/index.html}{Input Output Reference} document, it is grouped similarly to the IDD file.
