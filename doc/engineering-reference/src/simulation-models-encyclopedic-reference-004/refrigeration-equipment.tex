...
\begin{equation}
{P_{{\mathrm{rack}}}} = \frac{{\sum {{{\dot Q}_{case}} + \sum {{{\dot Q}_{walkin}}} } }}{{CO{P_{operating}}}}
\end{equation}
...
Factor\(_{Flow}\) is the doorway flow factor, = 0.8 if \(\Delta T_{Zn} \geq 11\,^{\circ}\mathrm{C}\); = 1.1 if \(\Delta T_{Zn} \leq 11\,^{\circ}\mathrm{C}\)
...
\begin{equation}
{Q_{{\mathrm{Total}}}} = {Q_{{\mathrm{Nominal}}}} \times \frac{{WetCoilFactor({T_{{\mathrm{Coil,inlet}}}})}}{{WetCoilFactor({\mathrm{Standard Condition}})}} \times \frac{{\Delta T}}{{\Delta {T_{{\mathrm{Rated}}}}}}
\end{equation}
...
\begin{equation}
{\dot Q_{{\mathrm{Refrigeration}}}} = \sum {{{\dot Q}_{case}}}  + \sum {{{\dot Q}_{walkin}}} ( + \sum {{{\dot Q}_{PipeHeatGain}}} )
\end{equation}

\begin{equation}
{\dot Q_{System,Estimated}} = {\dot Q_{{\mathrm{Refrigeration}}}} + {P_{Compressors,Estimated}}
\end{equation}
...
\begin{equation}
{P_{{\mathop\mathrm{int}} ercooler}} = \sqrt {\left( {{P_{evaporator}}} \right)\left( {{P_{condenser}}} \right)}
\end{equation}
...
\begin{equation}
{P_{CondFan}} = ({\mathrm{Air~Volume~Ratio}}){P_{CondFan,design}}
\end{equation}
...
\(\Delta T_{approach}\) is the rated approach temperature difference for the cascade condenser (\(\Delta\,^{\circ}\mathrm{C}\))
...
\begin{equation}
{\dot Q_{{\mathrm{Cascade}}}} = {\sum {\dot Q}_{{\mathrm{Case}}}} + \sum {{{\dot Q}_{{\mathrm{Walkin}}}} + } \sum {{{\dot Q}_{{\mathrm{Compressor}}}}} \left( { + \sum {{{\dot Q}_{{\mathrm{PipeHeatGain}}}}} } \right)
\end{equation}
...
\begin{equation}
Flo{w_{{\mathrm{RatedVol}}}} = \frac{{\sum {{{\dot Q}_{{\mathrm{Case}}}} + \sum {{{\dot Q}_{{\mathrm{WalkIn}}}} + Powe{r_{{\mathrm{Pump}}}}} } }}{{{\rho_{Liquid}}\Delta {h_{fg}}}}
\end{equation}
...
\begin{equation}
{\dot Q_{Pump}} = \left[ {A{{\left( {L{F_{Pump}}} \right)}^3} + B{{\left( {L{F_{Pump}}} \right)}^2} + C\left( {L{F_{Pump}}} \right) + D} \right] \times {\mathrm{Powe}}{{\mathrm{r}}_{{\mathrm{PumpRated}}}} \times {\mathrm{Rati}}{{\mathrm{o}}_{{\mathrm{PowertoHeat}}}}
\end{equation}
...
\({\dot Q_{{\mathrm{Refrigeration}}}}\) is the output variable ``Refrigeration Secondary Loop Load Heat Transfer Rate'' (W)

\({\dot Q_{{\mathrm{TotalSecondary}}}}\) is the total load the secondary loop transfers to the primary system, output variable ``Refrigeration Secondary Loop Total Heat Transfer Rate'' (W)

\({\dot Q_{{\mathrm{Pump}}}}\) is the pump power, function of Flow\(_{Needed}\), output variable ``Refrigeration Secondary Loop Pump Electric Power'' (W)
