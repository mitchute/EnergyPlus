...
\(h_{\mathrm{control~zone}}\) is the enthalpy of air in the control zone where the thermostat is located (J/kg)
...
\item Pressure drop across the suction and discharge valves, \(\Delta P\)
\item Loss factor used to define the electromechanical losses supposed to be proportional to the theoretical power, \({\mathrm{\eta }}\)
\item Superheat in \(^{\circ}\)C or F, \(\Delta T_{\mathrm{sh}}\)
\item Constant part of the electromechanical losses, \({\mathrm{W}}{}_{{\mathrm{loss}}}\)
...
\({\mathrm{W}}{}_{{\mathrm{cat}}}\) is the catalog power consumption

\({\mathrm{W}}{}_{}\) is the model power consumption

\({\mathrm{QL}}{}_{{\mathrm{cat}}}\) is the catalog load side heat transfer

\({\mathrm{QL}}{}_{}\) is the model load side heat transfer.
