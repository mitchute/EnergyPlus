...
\begin{longtable}[c]{@{}p{0.14\linewidth}p{0.48\linewidth}p{0.32\linewidth}@{}}
...
\begin{equation}
{\dot Q_{\operatorname{Re} quired}} = \dot m\left( {{h_{out,desired}} - {h_{in,sys}}} \right)
\end{equation}

\begin{equation}
PLF = \frac{{{{\dot Q}_{\operatorname{Re} quired}}}}{{{{\dot Q}_{Full}}}}
\end{equation}
