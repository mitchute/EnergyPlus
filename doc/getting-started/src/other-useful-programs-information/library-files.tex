...
The files in the DataSets and MacroDataSets folders are described in more detail in the ``\href{https://energyplus.readthedocs.io/en/latest/guides/output-details-and-examples/index.html}{Output Details and Examples}'' document.
