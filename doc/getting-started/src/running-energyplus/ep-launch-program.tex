...
The contents (along with examples) are discussed in the \href{https://energyplus.readthedocs.io/en/latest/guides/output-details-and-examples/index.html}{Output Details} document.
...
1.~Variable -- tabulated results in comma, tab or space delimited format (generated by the ReadVarsESO postprocessor or with OutputControl:Files) (F4)
...
10.~METER File -- tabulated meter report in comma, tab or space delimited format (generated by the ReadVarsESO postprocessor or with OutputControl:Files) (Ctrl-F4)
