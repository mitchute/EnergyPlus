...
The following output files are the most important for beginning users.~ Then, there is the section on ``other output'' files.~ And, more information about output files (complete list) is shown in the \href{https://energyplus.readthedocs.io/en/latest/guides/output-details-and-examples/index.html}{Output Details and Examples} Document.
