...
However, many people may read the code -- as developers, we should try to make it as readable at first glance as possible.~ For a true example from the code and a general indication of preferred style, take the case of the zone temperature update equation.~ In the \href{https://energyplus.readthedocs.io/en/latest/guides/engineering-reference/index.html}{Engineering Reference} document, the form is recognizable and usual:
