...
More information about standard error message formatting is contained in the \href{https://energyplus.readthedocs.io/en/latest/guides/output-details-and-examples/index.html}{Output Details and Examples} document (for the user) and (for the developer) in this document section: Standard Message Format.
