...
% Keep long chapter and section marks clear of the page number.  The standard
% headings page style lets marks grow into the number on narrow pages.
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{\thepage}
\fancyhead[LO]{\parbox[b]{0.82\headwidth}{\raggedright\small\slshape\nouppercase{\rightmark}}}
\fancyhead[RE]{\parbox[b]{0.82\headwidth}{\raggedleft\small\slshape\nouppercase{\leftmark}}}
