...
See pull request [#10974](https://github.com/NatLabRockies/EnergyPlus/pull/10974)
...
See pull request [#11217](https://github.com/NatLabRockies/EnergyPlus/pull/11217)
...
See pull request [#10971](https://github.com/NatLabRockies/EnergyPlus/pull/10971)

# Object Change: Coil:Heating:WaterToAirHeatPump:VariableSpeedEquationFit

Rename field `speed_1_reference_unit_rated_air_flow` to `speed_1_reference_unit_rated_air_flow_rate`

See pull request [#11075](https://github.com/NREL/EnergyPlus/pull/11075).

# Object Change: Coil:Cooling:DX:VariableSpeed

For speeds 6–10, rename the condenser airflow fields to `speed_{N}_reference_unit_rated_condenser_air_flow_rate`

See pull request [#11075](https://github.com/NREL/EnergyPlus/pull/11075).

# Object Change: Coil:Heating:DX:VariableSpeed

For speeds 4–10, rename `speed_{N}_heating_capacity_function_of_air_flow_fraction_curve_name` to `speed_{N}_total_heating_capacity_function_of_air_flow_fraction_curve_name`

See pull request [#11075](https://github.com/NREL/EnergyPlus/pull/11075).

# Object Change: Coil:WaterHeating:AirToWaterHeatPump:VariableSpeed
For speeds 1–10, rename:
- `rated_water_heating_capacity_at_speed_{N}` to `speed_{N}_rated_water_heating_capacity`
- `rated_water_heating_cop_at_speed_{N}` to`speed_{N}_rated_water_heating_cop`
- `rated_sensible_heat_ratio_at_speed_{N}` to `speed_{N}_rated_sensible_heat_ratio`
